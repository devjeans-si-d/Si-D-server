...
public class ProjectAcceptController {
    ...
    public ResponseEntity<Page<ApplicantResponse>> getApplicants(@PageableDefault(size = 3) Pageable pageable, @PathVariable Long projectId) {
    ...
    public ResponseEntity<List<MyProjectResponse>> getMyProjects(@PageableDefault(size = 3) Pageable pageable) {
    ...
    public ResponseEntity<Page<ApplicationResponse>> getMyApplicationList(@PageableDefault(size = 3) Pageable pageable) {
